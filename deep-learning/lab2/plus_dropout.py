...
network = Two_Dimensional_Network(K=K, d=d, m=m, dropout_rate=dropout_rate)
...
print("Best validation accuracy", max(network.validation_accuracy))
...
plt.ylabel('Cost')
plt.title(f"Cost \n lambda={format(llambda, ".5f")}, n_s={n_s}, batch_size={batch_size},\n eta_min={eta_min}, eta_max={eta_max}")
plt.show()
plt.figure() 
