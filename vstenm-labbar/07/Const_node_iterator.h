...
public:
    ...
    const_real_node_iterator &next_node()
    {
        if (!m_stack.empty())
        {
    ...
    const_real_node_iterator(Node<S, T> *pointer, Node<S, T> *root)
    {
        m_pointer = pointer;
    ...
    const_real_node_iterator(Node<S, T> *pointer, bool reversed, bool is_const, Node<S, T> *root)
    {
        m_pointer = pointer;
        stack_pointer = pointer;
